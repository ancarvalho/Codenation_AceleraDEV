...
def q1():
    desc = dataframe.describe().T[["25%", "50%", "75%"]].T
...
def q5():
    ...
    empiric_quantil = non_pulse_stars_standardized.quantile(quartis)
    theoric_quantil = sct.norm.ppf(quartis)
    return tuple(np.round(empiric_quantil-theoric_quantil, 3))
